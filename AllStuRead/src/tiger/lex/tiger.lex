...
[_a-zA-Z][_0-9a-zA-Z]* {adjust(); string_buf_ = matched(); return Parser::ID;}
...
<INITIAL> [\"] {adjust(); begin(StartCondition__::STR); string_buf_.clear();}
...
\\[0-9]+ {adjustStr(); string_buf_ += (char)atoi(matched().c_str() + 1); }
